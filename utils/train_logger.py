def epoch_summary(epoch, avg_val_psnr, avg_val_ssim, train_mse_loss, train_percept_loss=None, train_gen_loss=None, width=75):
    line = "-" * width
    # Epoch
    print(line)
    ...
    # Validation metrics
    metric_str = f"Metrics → PSNR: {avg_val_psnr:.4f}   SSIM: {avg_val_ssim:.4f}"
